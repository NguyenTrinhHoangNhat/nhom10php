						...
						while ($row = mysqli_fetch_array($rs)) {
							...
							<tbody>
								<tr>
									...
									<td><a href="index.php?action=quanlydiennuoc&view=them&map=<?php echo $row['MaPhong'] ?>"><i class="fas fa-location-arrow"></i> Thêm</a></td>
								</tr>
							</tbody>
					...
					<table class="table-hover table text-center">
						<thead>
							<tr class="badge-info">
								...
								<th>Khu</th>
								<th>Số người đang ở</th>
								<th class="badge-danger">Chức năng</th>
							</tr>
						</thead>
						<?php $i = 0;
							while ($row = mysqli_fetch_array($rs)) {
