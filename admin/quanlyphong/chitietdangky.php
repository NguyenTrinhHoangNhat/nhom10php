		...
		<table class="table">
			<thead>
				<tr class="badge-info text-center">
					<td colspan="2">
						<h3>Thông tin sinh viên đăng ký</h3>
					</td>
				</tr>
				<tr>
					<th>Mã sinh viên</th>
	...
	<div class="card col-6">
		<table class="table">
			<thead>
				...
				<tr>
					<th>Mã Phòng</th>
					<th> <?php echo $row1['MaPhong'] ?></th>
				</tr>
				<tr>
					<th>Mã Khu</th>
					<th> <?php echo $row1['MaKhu'] . ' (Khu ' . $row2['Sex'] . ')'; ?></th>
				</tr>
				<tr>
					<th>Số Người Tối Đa</th>
					<th> <?php echo $row1['SoNguoiToiDa'] ?></th>
				</tr>
				<tr>
					<th>số Người hiện tại</th>
					<th> <?php if ($row1['SoNguoiHienTai'] >= 1) {
								echo $row1['SoNguoiHienTai'] - 1;
							} else {
								echo $row1['SoNguoiHienTai'];
							} ?></th>
				</tr>
				<tr>
					<th>Giá</th>
					<th> <?php echo number_format($row1['Gia']) . ' đ' ?></th>
				</tr>
				<tr>
					<th> &emsp;</th>
					<th> &emsp;</th>
