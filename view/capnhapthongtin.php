  ...
  ?>
    <div class="cart" style="width: 1000px; margin-top: -48px;">
        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" action="xuly/main.php?action=capnhapthongtin" method="POST">
              ...
              <input hidden type="text" id="inputText" class="form-control" value="<?php echo $row['MaSV'] ?>" disabled>
              ...
              <div class="form-label-group">
                <input type="date" name="ns" max="2024-06-03" min="1900-01-01" class="form-control" value="<?php echo $row['NgaySinh'] ?>">
              </div>
              <hr>
              <span>Quê quán </span>
              <div class="form-label-group">
