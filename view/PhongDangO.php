...
?>
  <div class="cart" style="margin-top: -48px; width: 970px;">
          ...
          <form class="col-md-12 m-auto" action="" method="">
            <div class="form-row m-auto">
              <div class="form-group col-sm-2"></div>
                ...
                <input hidden type="text" class="form-control" id="masv" value="<?php echo $sv['MaSV'] ?>" disabled>
             
              
                <input hidden type="text" class="form-control" id="hoten" value="<?php echo $sv['HoTen'] ?>" disabled>
